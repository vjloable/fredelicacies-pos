...
export default function DeleteConfirmationModal({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      onError(`Failed to ${deleteOption === 'soft' ? 'deactivate' : 'delete'} branch. Please try again.`);
    } finally {
      setLoading(false);
    }
  };
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-[var(--secondary)] mb-2">
              {deleteOption === 'soft' ? 'Deactivating Branch...' : 'Deleting Branch...'}
            </h3>
          ...
          <>
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl font-bold text-[var(--secondary)] mb-2">
                {deleteOption === 'soft' ? 'Deactivate Branch' : 'Delete Branch'}
              </h3>
              <p className="text-[var(--secondary)] opacity-70">
                {deleteOption === 'soft' 
            ...
            <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <h4 className="font-semibold text-red-900 mb-1">{branch.name}</h4>
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium text-[var(--secondary)] mb-2">
                Type the branch name to confirm: <span className="font-mono bg-gray-100 px-1 rounded">{branch.name}</span>
              </label>
              <input
                type="text"
              ...
              {confirmationText && !isConfirmationValid && (
                <p className="text-xs text-red-600 mt-1">
                  Branch name doesn't match. Please type exactly: {branch.name}
                </p>
              )}
            </div>
            ...
            <div className="flex gap-4">
              ...
              >
                {deleteOption === 'soft' ? 'Deactivate Branch' : 'Delete Permanently'}
              </button>
            </div>
          </>
        )}
