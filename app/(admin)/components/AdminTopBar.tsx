					...
					{isUserAdmin() && (
						<div className='flex-shrink-0'>
							<div className="h-14 px-3 py-3 text-center flex bg-[var(--primary)] rounded-xl text-[var(--secondary)] gap-2 items-center font-medium text-[12px] lg:text-[14px] ">
								<span className='w-8 h-8 bg-[var(--accent)]/20 rounded-full flex items-center justify-center text-[var(--accent)] text-xs font-bold'>
									A
								</span>
								<span className="text-[var(--accent)] font-semibold">Admin</span>
							</div>
						</div>
					)}
