        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6">
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <h2 className="text-xl font-semibold text-[var(--secondary)] mb-2">Sales Page</h2>
              <p className="text-[var(--secondary)] opacity-70">This page is ready for sales features.</p>
            </div>
          </div>
        </div>
      </div>
