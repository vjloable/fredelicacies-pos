					...
					<div className='text-center max-w-lg mx-auto px-6'>
						...
						<div className='space-y-6'>
							<div className='flex flex-col sm:flex-row gap-4 justify-center'>
								<Link
									href='/'
									className='flex items-center justify-center gap-2 bg-accent text-primary px-8 py-4 rounded-lg hover:bg-accent/90 transition-colors font-medium shadow-lg hover:shadow-xl text-base'>
								...
								<Link
									href='/login'
									className='flex items-center justify-center gap-2 bg-secondary/10 text-secondary px-8 py-4 rounded-lg hover:bg-secondary/20 transition-colors font-medium border border-secondary/20 text-base'>
									<svg className='w-5 h-5' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
							...
							<div className='pt-6 border-t border-secondary/10'>
								<p className='text-xs text-secondary/50 mb-4'>Common pages you might be looking for:</p>
								<div className='grid grid-cols-2 sm:grid-cols-3 gap-3'>
									<Link
										href='/owner'
										className='text-xs text-accent hover:text-accent/80 py-2 px-4 rounded-md hover:bg-accent/10 transition-colors border border-accent/20'>
										Dashboard
									</Link>
									<Link
										href='/owner/branches'
